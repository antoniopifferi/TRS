...
#define THmod_MAXDEVNUM	 4	    // max number of devices
 
#define MAXINPCHAN   2	    // max number of detector input channels

#define THmod_MAXBINSTEPS	22	    // get actual number via TH260_GetBaseResolution() !

#define THmod_MAXHISTLEN  32768	// max number of histogram bins
#define THmod_MAXLENCODE  5		// max length code histo mode
...
#define THmod_OFFSETMAX	100000000	//ns 
#define ACQTMIN		1			//ms
