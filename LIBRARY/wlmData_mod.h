// NOTE: Antonio Pifferi: modified to avoid conflicts with constants (e.g. CE, CT) Modified Functions indicated with //MOD
...
//	void __stdcall            CallbackProcEx(t_i32val Ver,   t_i32val Mode,   t_i32val IntVal,   t_dblval DblVal,   t_i32val Res1) ;
	...
	Data_API(t_i32val)        SetWLMPriority(t_i32val PPC_,   t_i32val Res1,   t_i32val Res2) ;
...
// ***********  General Get... & Set...-functions  **********************
	...
	Data_API(t_dblval)        GetCalibrationEffect(t_dblval CE_) ; //MOD
	...
	Data_API(t_u16val)        GetRange_(t_u16val R_) ; //MOD
	Data_API(t_i32val)        SetRange_(t_u16val R_) ; //MOD
	...
	Data_API(t_i32val)        GetPulseIntegration(t_i32val PI_) ; //MOD
	Data_API(t_i32val)        SetPulseIntegration(t_i32val PI_) ; //MOD
