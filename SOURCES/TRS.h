...
#define  SOLUS_P_USE_TRIM_FILE            38      /* control type: binary, callback function: Setting */
#define  SOLUS_P_PRODUCE_TRIM_FILE        39      /* control type: binary, callback function: Setting */
#define  SOLUS_P_MULTI_LINE_ACQ           40      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG6                    41      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG7                    42      /* control type: ring, callback function: Setting */
#define  SOLUS_P_AUTOCAL                  43      /* control type: binary, callback function: Setting */
#define  SOLUS_P_POWER_OPTODE_1           44      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_2           45      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_3           46      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_4           47      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_8           48      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_7           49      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_6           50      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_5           51      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_LASER_FREQ               52      /* control type: numeric, callback function: (none) */
#define  SOLUS_P_START_PIXEL              53      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_STOP_PIXEL               54      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_1            55      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_2            56      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_3            57      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_4            58      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_5            59      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_6            60      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_7            61      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_8            62      /* control type: numeric, callback function: Setting */
