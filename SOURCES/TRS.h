...
#define  PARM_MEAS_CLEAR                  103     /* control type: binary, callback function: Setting */
#define  PARM_MEAS_STOP                   104     /* control type: binary, callback function: Setting */
#define  PARM_MEAS_SKIPOSCILL             105     /* control type: binary, callback function: Setting */
#define  PARM_MEAS_AUTORUN                106     /* control type: binary, callback function: Setting */
#define  PARM_CONST_RHO                   107     /* control type: numeric, callback function: Setting */
#define  PARM_CONST_THICK                 108     /* control type: numeric, callback function: Setting */
#define  PARM_CONST_N                     109     /* control type: numeric, callback function: Setting */
#define  PARM_TEXTMSG_5                   110     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_4                   111     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_3                   112     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_2                   113     /* control type: textMsg, callback function: (none) */
#define  PARM_TIME_BASE_TEXT              114     /* control type: textMsg, callback function: (none) */
#define  PARM_TITLE                       115     /* control type: textMsg, callback function: (none) */
#define  PARM_LOOP_TITLE                  116     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_1                   117     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG                     118     /* control type: textMsg, callback function: (none) */
#define  PARM_MEAS_TITLE                  119     /* control type: textMsg, callback function: (none) */
#define  PARM_POWER_TITLE                 120     /* control type: textMsg, callback function: (none) */
#define  PARM_SYNC_TITLE                  121     /* control type: textMsg, callback function: (none) */
#define  PARM_OSCILL_TITLE                122     /* control type: textMsg, callback function: (none) */
#define  PARM_FILE_TITLE                  123     /* control type: textMsg, callback function: (none) */
#define  PARM_JUMP_TITLE                  124     /* control type: textMsg, callback function: (none) */
#define  PARM_INFO_TITLE                  125     /* control type: textMsg, callback function: (none) */
