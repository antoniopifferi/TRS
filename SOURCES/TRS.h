...
#define  PARM_FILE_DIR                    87      /* control type: string, callback function: Setting */
#define  PARM_FILE_EXT                    88      /* control type: string, callback function: Setting */
#define  PARM_FILE_PREFIX                 89      /* control type: string, callback function: Setting */
#define  PARM_FILE_TAG                    90      /* control type: numeric, callback function: Setting */
#define  PARM_FILE_TYPE                   91      /* control type: ring, callback function: Setting */
#define  PARM_INFO_MONITOR                92      /* control type: binary, callback function: Setting */
#define  PARM_INFO_SUBHEADER              93      /* control type: binary, callback function: Setting */
#define  PARM_LAYOUT                      94      /* control type: binary, callback function: Setting */
#define  PARM_FLAGPRESENT                 95      /* control type: binary, callback function: Setting */
#define  PARM_OMA_LOOP                    96      /* control type: ring, callback function: Setting */
#define  PARM_OPHIR_LOOP                  97      /* control type: ring, callback function: Setting */
#define  PARM_MEAS_STATUS                 98      /* control type: numeric, callback function: Setting */
#define  PARM_MEAS_DISPLAY                99      /* control type: numeric, callback function: Setting */
#define  PARM_MEAS_MEM                    100     /* control type: numeric, callback function: Setting */
#define  PARM_MEAS_ROI                    101     /* control type: numeric, callback function: Setting */
#define  PARM_MEAS_CLEAR                  102     /* control type: binary, callback function: Setting */
#define  PARM_MEAS_STOP                   103     /* control type: binary, callback function: Setting */
#define  PARM_MEAS_SKIPOSCILL             104     /* control type: binary, callback function: Setting */
#define  PARM_MEAS_AUTORUN                105     /* control type: binary, callback function: Setting */
#define  PARM_CONST_RHO                   106     /* control type: numeric, callback function: Setting */
#define  PARM_CONST_THICK                 107     /* control type: numeric, callback function: Setting */
#define  PARM_CONST_N                     108     /* control type: numeric, callback function: Setting */
#define  PARM_TEXTMSG_5                   109     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_4                   110     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_3                   111     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_2                   112     /* control type: textMsg, callback function: (none) */
#define  PARM_TIME_BASE_TEXT              113     /* control type: textMsg, callback function: (none) */
#define  PARM_TITLE                       114     /* control type: textMsg, callback function: (none) */
#define  PARM_LOOP_TITLE                  115     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_1                   116     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG                     117     /* control type: textMsg, callback function: (none) */
#define  PARM_MEAS_TITLE                  118     /* control type: textMsg, callback function: (none) */
#define  PARM_POWER_TITLE                 119     /* control type: textMsg, callback function: (none) */
#define  PARM_SYNC_TITLE                  120     /* control type: textMsg, callback function: (none) */
#define  PARM_OSCILL_TITLE                121     /* control type: textMsg, callback function: (none) */
#define  PARM_FILE_TITLE                  122     /* control type: textMsg, callback function: (none) */
#define  PARM_JUMP_TITLE                  123     /* control type: textMsg, callback function: (none) */
#define  PARM_INFO_TITLE                  124     /* control type: textMsg, callback function: (none) */
#define  PARM_CHANN_TITLE                 125     /* control type: textMsg, callback function: (none) */
#define  PARM_SPC_TITLE                   126     /* control type: textMsg, callback function: (none) */
