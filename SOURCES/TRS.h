...
#define  SOLUS_P_SWITCH_OFF_LASERS        9       /* control type: command, callback function: SwitchOffLasers */
#define  SOLUS_P_EXPO_GSIPM_PARM_FILE     10      /* control type: command, callback function: ExportGSIPMParmsFile */
#define  SOLUS_P_EXPORT_GSIPM_FILE        11      /* control type: command, callback function: ExportGSIPMFile */
#define  SOLUS_P_EXPORT_LDs_FILE          12      /* control type: command, callback function: ExportLDsFile */
#define  SOLUS_P_EXPORT_SEQUENCE          13      /* control type: command, callback function: ExportMeasSequence */
#define  SOLUS_P_OPT1                     14      /* control type: LED, callback function: (none) */
#define  SOLUS_P_OPT2                     15      /* control type: LED, callback function: (none) */
#define  SOLUS_P_OPT3                     16      /* control type: LED, callback function: (none) */
#define  SOLUS_P_OPT4                     17      /* control type: LED, callback function: (none) */
#define  SOLUS_P_OPT5                     18      /* control type: LED, callback function: (none) */
#define  SOLUS_P_OPT6                     19      /* control type: LED, callback function: (none) */
#define  SOLUS_P_OPT7                     20      /* control type: LED, callback function: (none) */
#define  SOLUS_P_OPT8                     21      /* control type: LED, callback function: (none) */
#define  SOLUS_P_TRIM_POS_FILE_PATH       22      /* control type: string, callback function: Setting */
#define  SOLUS_P_CALIB_MAP_FILE_PATH      23      /* control type: string, callback function: Setting */
#define  SOLUS_P_LDs_PARM_FILE_PATH       24      /* control type: string, callback function: Setting */
#define  SOLUS_P_GSIPM_PARM_FILE_PATH     25      /* control type: string, callback function: Setting */
#define  SOLUS_P_GSIPM_INFO_FILE_PATH     26      /* control type: string, callback function: Setting */
#define  SOLUS_P_LDs_INFO_FILE_PATH       27      /* control type: string, callback function: Setting */
#define  SOLUS_P_SEQUENCE_FILE_PATH       28      /* control type: string, callback function: Setting */
#define  SOLUS_P_T_OPTODE_DIAGNOSTIC      29      /* control type: table, callback function: Setting */
#define  SOLUS_P_SEQ_LENGTH               30      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_T_AUTOCAL_PARAMS         31      /* control type: table, callback function: Setting */
#define  SOLUS_P_T_CONTROL_PARAMS         32      /* control type: table, callback function: Setting */
#define  SOLUS_P_T_CONTROL_DIAGNOSTIC     33      /* control type: table, callback function: Setting */
#define  SOLUS_P_FLAG1                    34      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG2                    35      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG3                    36      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG4                    37      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG5                    38      /* control type: binary, callback function: Setting */
#define  SOLUS_P_MULTI_LINE_ACQ           39      /* control type: binary, callback function: Setting */
#define  SOLUS_P_SAVE_DUMP                40      /* control type: binary, callback function: Setting */
#define  SOLUS_P_ADD_TEMP_IN_MEAS         41      /* control type: binary, callback function: Setting */
#define  SOLUS_P_INTERLOCK_BYP            42      /* control type: binary, callback function: Setting */
#define  SOLUS_P_USE_LEGACY_SEQ           43      /* control type: binary, callback function: Setting */
#define  SOLUS_P_USE_TRIM_FILE            44      /* control type: binary, callback function: Setting */
#define  SOLUS_P_PRODUCE_TRIM_FILE        45      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG6                    46      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG7                    47      /* control type: ring, callback function: Setting */
#define  SOLUS_P_AUTOCAL                  48      /* control type: binary, callback function: Setting */
#define  SOLUS_P_POWER_OPTODE_1           49      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_2           50      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_3           51      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_4           52      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_8           53      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_7           54      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_6           55      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_5           56      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_LASER_FREQ               57      /* control type: numeric, callback function: (none) */
#define  SOLUS_P_START_PIXEL              58      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_STOP_PIXEL               59      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_1            60      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_2            61      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_3            62      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_4            63      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_5            64      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_6            65      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_7            66      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_8            67      /* control type: numeric, callback function: Setting */
