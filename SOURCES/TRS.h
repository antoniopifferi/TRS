...
#define  PARM_MEAS_STATUS                 91      /* control type: numeric, callback function: Setting */
#define  PARM_MEAS_DISPLAY                92      /* control type: numeric, callback function: Setting */
#define  PARM_MEAS_MEM                    93      /* control type: numeric, callback function: Setting */
#define  PARM_MEAS_ROI                    94      /* control type: numeric, callback function: Setting */
#define  PARM_MEAS_CLEAR                  95      /* control type: binary, callback function: Setting */
#define  PARM_MEAS_STOP                   96      /* control type: binary, callback function: Setting */
#define  PARM_MEAS_SKIPOSCILL             97      /* control type: binary, callback function: Setting */
#define  PARM_MEAS_AUTORUN                98      /* control type: binary, callback function: Setting */
#define  PARM_CONST_RHO                   99      /* control type: numeric, callback function: Setting */
#define  PARM_CONST_THICK                 100     /* control type: numeric, callback function: Setting */
#define  PARM_CONST_N                     101     /* control type: numeric, callback function: Setting */
#define  PARM_TIME_BASE                   102     /* control type: ring, callback function: Setting */
#define  PARM_READ_UIR                    103     /* control type: binary, callback function: Setting */
#define  PARM_TEXTMSG_5                   104     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_4                   105     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_3                   106     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_2                   107     /* control type: textMsg, callback function: (none) */
#define  PARM_TIME_BASE_TEXT              108     /* control type: textMsg, callback function: (none) */
#define  PARM_TITLE                       109     /* control type: textMsg, callback function: (none) */
#define  PARM_LOOP_TITLE                  110     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_1                   111     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG                     112     /* control type: textMsg, callback function: (none) */
#define  PARM_MEAS_TITLE                  113     /* control type: textMsg, callback function: (none) */
#define  PARM_POWER_TITLE                 114     /* control type: textMsg, callback function: (none) */
#define  PARM_SYNC_TITLE                  115     /* control type: textMsg, callback function: (none) */
#define  PARM_OSCILL_TITLE                116     /* control type: textMsg, callback function: (none) */
#define  PARM_FILE_TITLE                  117     /* control type: textMsg, callback function: (none) */
#define  PARM_JUMP_TITLE                  118     /* control type: textMsg, callback function: (none) */
#define  PARM_INFO_TITLE                  119     /* control type: textMsg, callback function: (none) */
#define  PARM_CHANN_TITLE                 120     /* control type: textMsg, callback function: (none) */
#define  PARM_SPC_TITLE                   121     /* control type: textMsg, callback function: (none) */
#define  PARM_DCR_FILE_ROOT_TDC           122     /* control type: string, callback function: Setting */
#define  PARM_SC_SEL_REP_NUM              123     /* control type: numeric, callback function: Setting */
#define  PARM_SC1000_FIRST                124     /* control type: numeric, callback function: Setting */
#define  PARM_SC1000_LAST                 125     /* control type: numeric, callback function: Setting */
