...
#define  SOLUS_P_TRIM_POS_FILE_PATH       21      /* control type: string, callback function: Setting */
#define  SOLUS_P_CALIB_MAP_FILE_PATH      22      /* control type: string, callback function: Setting */
#define  SOLUS_P_LDs_PARM_FILE_PATH       23      /* control type: string, callback function: Setting */
#define  SOLUS_P_GSIPM_PARM_FILE_PATH     24      /* control type: string, callback function: Setting */
#define  SOLUS_P_GSIPM_INFO_FILE_PATH     25      /* control type: string, callback function: Setting */
#define  SOLUS_P_LDs_INFO_FILE_PATH       26      /* control type: string, callback function: Setting */
#define  SOLUS_P_SEQUENCE_FILE_PATH       27      /* control type: string, callback function: Setting */
#define  SOLUS_P_T_OPTODE_DIAGNOSTIC      28      /* control type: table, callback function: Setting */
#define  SOLUS_P_SEQ_LENGTH               29      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_T_AUTOCAL_PARAMS         30      /* control type: table, callback function: Setting */
#define  SOLUS_P_T_CONTROL_PARAMS         31      /* control type: table, callback function: Setting */
#define  SOLUS_P_T_CONTROL_DIAGNOSTIC     32      /* control type: table, callback function: Setting */
#define  SOLUS_P_FLAG1                    33      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG2                    34      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG3                    35      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG4                    36      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG5                    37      /* control type: binary, callback function: Setting */
#define  SOLUS_P_MULTI_LINE_ACQ           38      /* control type: binary, callback function: Setting */
#define  SOLUS_P_SAVE_DUMP                39      /* control type: binary, callback function: Setting */
#define  SOLUS_P_ADD_TEMP_IN_MEAS         40      /* control type: binary, callback function: Setting */
#define  SOLUS_P_INTERLOCK_BYP            41      /* control type: binary, callback function: Setting */
#define  SOLUS_P_USE_LEGACY_SEQ           42      /* control type: binary, callback function: Setting */
#define  SOLUS_P_USE_TRIM_FILE            43      /* control type: binary, callback function: Setting */
#define  SOLUS_P_PRODUCE_TRIM_FILE        44      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG6                    45      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG7                    46      /* control type: ring, callback function: Setting */
#define  SOLUS_P_AUTOCAL                  47      /* control type: binary, callback function: Setting */
#define  SOLUS_P_POWER_OPTODE_1           48      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_2           49      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_3           50      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_4           51      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_8           52      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_7           53      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_6           54      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_5           55      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_LASER_FREQ               56      /* control type: numeric, callback function: (none) */
#define  SOLUS_P_START_PIXEL              57      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_STOP_PIXEL               58      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_1            59      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_2            60      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_3            61      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_4            62      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_5            63      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_6            64      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_7            65      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_8            66      /* control type: numeric, callback function: Setting */
