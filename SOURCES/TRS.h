...
#define  SOLUS_P_USE_LEGACY_SEQ           38      /* control type: binary, callback function: Setting */
#define  SOLUS_P_MULTI_LINE_ACQ           39      /* control type: binary, callback function: Setting */
#define  SOLUS_P_USE_TRIM_FILE            40      /* control type: binary, callback function: Setting */
#define  SOLUS_P_PRODUCE_TRIM_FILE        41      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG6                    42      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG7                    43      /* control type: ring, callback function: Setting */
#define  SOLUS_P_AUTOCAL                  44      /* control type: binary, callback function: Setting */
#define  SOLUS_P_POWER_OPTODE_1           45      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_2           46      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_3           47      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_4           48      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_8           49      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_7           50      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_6           51      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_5           52      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_LASER_FREQ               53      /* control type: numeric, callback function: (none) */
#define  SOLUS_P_START_PIXEL              54      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_STOP_PIXEL               55      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_1            56      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_2            57      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_3            58      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_4            59      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_5            60      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_6            61      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_7            62      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_8            63      /* control type: numeric, callback function: Setting */
