...
#define  SOLUS_P_T_CONTROL_PARAMS         29      /* control type: table, callback function: Setting */
#define  SOLUS_P_T_CONTROL_DIAGNOSTIC     30      /* control type: table, callback function: Setting */
#define  SOLUS_P_FLAG1                    31      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG2                    32      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG3                    33      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG4                    34      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG5                    35      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG6                    36      /* control type: binary, callback function: Setting */
#define  SOLUS_P_AUTOCAL                  37      /* control type: binary, callback function: Setting */
#define  SOLUS_P_POWER_OPTODE_1           38      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_2           39      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_3           40      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_4           41      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_8           42      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_7           43      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_6           44      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_5           45      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_LASER_FREQ               46      /* control type: numeric, callback function: (none) */
#define  SOLUS_P_START_PIXEL              47      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_STOP_PIXEL               48      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_1            49      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_2            50      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_3            51      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_4            52      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_5            53      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_6            54      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_7            55      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_8            56      /* control type: numeric, callback function: Setting */
