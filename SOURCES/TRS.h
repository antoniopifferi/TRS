...
#define  SOLUS_P_FLAG7                    38      /* control type: ring, callback function: Setting */
#define  SOLUS_P_AUTOCAL                  39      /* control type: binary, callback function: Setting */
#define  SOLUS_P_POWER_OPTODE_1           40      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_2           41      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_3           42      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_4           43      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_8           44      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_7           45      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_6           46      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_5           47      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_LASER_FREQ               48      /* control type: numeric, callback function: (none) */
#define  SOLUS_P_START_PIXEL              49      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_STOP_PIXEL               50      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_1            51      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_2            52      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_3            53      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_4            54      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_5            55      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_6            56      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_7            57      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_8            58      /* control type: numeric, callback function: Setting */
