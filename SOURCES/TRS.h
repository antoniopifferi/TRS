...
#define  SOLUS_P_FLAG6                    40      /* control type: binary, callback function: Setting */
#define  SOLUS_P_FLAG7                    41      /* control type: ring, callback function: Setting */
#define  SOLUS_P_AUTOCAL                  42      /* control type: binary, callback function: Setting */
#define  SOLUS_P_POWER_OPTODE_1           43      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_2           44      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_3           45      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_4           46      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_8           47      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_7           48      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_6           49      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_5           50      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_LASER_FREQ               51      /* control type: numeric, callback function: (none) */
#define  SOLUS_P_START_PIXEL              52      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_STOP_PIXEL               53      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_1            54      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_2            55      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_3            56      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_4            57      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_5            58      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_6            59      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_7            60      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_8            61      /* control type: numeric, callback function: Setting */
