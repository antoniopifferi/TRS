...
#define  SOLUS_P_AUTOCAL                  31      /* control type: binary, callback function: Setting */
#define  SOLUS_P_POWER_OPTODE_1           32      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_2           33      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_3           34      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_4           35      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_8           36      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_7           37      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_6           38      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_POWER_OPTODE_5           39      /* control type: binary, callback function: PowerOptode */
#define  SOLUS_P_LASER_FREQ               40      /* control type: numeric, callback function: (none) */
#define  SOLUS_P_START_PIXEL              41      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_STOP_PIXEL               42      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_1            43      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_2            44      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_3            45      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_4            46      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_5            47      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_6            48      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_7            49      /* control type: numeric, callback function: Setting */
#define  SOLUS_P_OPTODE_AREA_8            50      /* control type: numeric, callback function: Setting */
