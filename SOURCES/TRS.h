...
#define  MHARP_INPUT_EDGE_2               6       /* control type: numeric, callback function: Setting */
#define  MHARP_INPUT_EDGE                 7       /* control type: numeric, callback function: Setting */
#define  MHARP_INPUT_LEVEL                8       /* control type: numeric, callback function: Setting */
#define  MHARP_SYNC_DEADTIME              9       /* control type: numeric, callback function: Setting */
#define  MHARP_INPUT_OFFSET               10      /* control type: numeric, callback function: Setting */
#define  MHARP_SYNC_EDGE                  11      /* control type: numeric, callback function: Setting */
#define  MHARP_SYNC_LEVEL                 12      /* control type: numeric, callback function: Setting */
#define  MHARP_SYNC_OFFSET                13      /* control type: numeric, callback function: Setting */
#define  MHARP_BINNING                    14      /* control type: numeric, callback function: Setting */
#define  MHARP_LABEL_9                    15      /* control type: textMsg, callback function: (none) */
#define  MHARP_LABEL_8                    16      /* control type: textMsg, callback function: (none) */
#define  MHARP_LABEL_10                   17      /* control type: textMsg, callback function: (none) */
#define  MHARP_LABEL_7                    18      /* control type: textMsg, callback function: (none) */
#define  MHARP_LABEL_4                    19      /* control type: textMsg, callback function: (none) */
#define  MHARP_LABEL_6                    20      /* control type: textMsg, callback function: (none) */
#define  MHARP_LABEL_5                    21      /* control type: textMsg, callback function: (none) */
#define  MHARP_LABEL_3                    22      /* control type: textMsg, callback function: (none) */
...
#define  PARM_FLOW_MULTI_THREAD           68      /* control type: binary, callback function: Setting */
#define  PARM_FLOW_FLOW                   69      /* control type: binary, callback function: Setting */
#define  PARM_READ_UIR                    70      /* control type: binary, callback function: Setting */
#define  PARM_CHANN_FIRST                 71      /* control type: numeric, callback function: Setting */
#define  PARM_CHANN_LAST                  72      /* control type: numeric, callback function: Setting */
#define  PARM_CHANN_NUM                   73      /* control type: numeric, callback function: (none) */
#define  PARM_INFO_KIND                   74      /* control type: ring, callback function: Setting */
#define  PARM_INFO_APPL                   75      /* control type: ring, callback function: Setting */
#define  PARM_INFO_GEOM                   76      /* control type: ring, callback function: Setting */
#define  PARM_JUMP_LOOP                   77      /* control type: ring, callback function: Setting */
#define  PARM_JUMP_BOARD                  78      /* control type: ring, callback function: Setting */
#define  PARM_JUMP_MAX                    79      /* control type: numeric, callback function: Setting */
#define  PARM_OSCILL_TIME                 80      /* control type: numeric, callback function: Setting */
#define  PARM_POWER_STEP                  81      /* control type: ring, callback function: Setting */
#define  PARM_SYNC_SYNC                   82      /* control type: binary, callback function: Setting */
#define  PARM_SYNC_TYPE                   83      /* control type: ring, callback function: Setting */
#define  PARM_SYNC_COM                    84      /* control type: numeric, callback function: Setting */
#define  PARM_SYNC_LOOP                   85      /* control type: ring, callback function: Setting */
#define  PARM_SYNC_PATTERN                86      /* control type: ring, callback function: Setting */
#define  PARM_SYNC_DIR                    87      /* control type: ring, callback function: Setting */
#define  PARM_SYNC_WIDTH                  88      /* control type: numeric, callback function: Setting */
#define  PARM_SYNC_BAUD                   89      /* control type: ring, callback function: Setting */
#define  PARM_FILE_DIR                    90      /* control type: string, callback function: Setting */
#define  PARM_FILE_EXT                    91      /* control type: string, callback function: Setting */
#define  PARM_FILE_PREFIX                 92      /* control type: string, callback function: Setting */
#define  PARM_FILE_TAG                    93      /* control type: numeric, callback function: Setting */
#define  PARM_FILE_TYPE                   94      /* control type: ring, callback function: Setting */
#define  PARM_INFO_MONITOR                95      /* control type: binary, callback function: Setting */
#define  PARM_INFO_SUBHEADER              96      /* control type: binary, callback function: Setting */
#define  PARM_LAYOUT                      97      /* control type: binary, callback function: Setting */
#define  PARM_FLAGPRESENT                 98      /* control type: binary, callback function: Setting */
#define  PARM_OMA_LOOP                    99      /* control type: ring, callback function: Setting */
#define  PARM_OPHIR_LOOP                  100     /* control type: ring, callback function: Setting */
#define  PARM_MEAS_STATUS                 101     /* control type: numeric, callback function: Setting */
#define  PARM_MEAS_DISPLAY                102     /* control type: numeric, callback function: Setting */
#define  PARM_MEAS_MEM                    103     /* control type: numeric, callback function: Setting */
#define  PARM_MEAS_ROI                    104     /* control type: numeric, callback function: Setting */
#define  PARM_FILE_SAVE                   105     /* control type: binary, callback function: Setting */
#define  PARM_MEAS_CLEAR                  106     /* control type: binary, callback function: Setting */
#define  PARM_MEAS_STOP                   107     /* control type: binary, callback function: Setting */
#define  PARM_MEAS_SKIPOSCILL             108     /* control type: binary, callback function: Setting */
#define  PARM_MEAS_AUTORUN                109     /* control type: binary, callback function: Setting */
#define  PARM_CONST_RHO                   110     /* control type: numeric, callback function: Setting */
#define  PARM_CONST_THICK                 111     /* control type: numeric, callback function: Setting */
#define  PARM_CONST_N                     112     /* control type: numeric, callback function: Setting */
#define  PARM_TEXTMSG_5                   113     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_4                   114     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_3                   115     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_2                   116     /* control type: textMsg, callback function: (none) */
#define  PARM_TIME_BASE_TEXT              117     /* control type: textMsg, callback function: (none) */
#define  PARM_TITLE                       118     /* control type: textMsg, callback function: (none) */
#define  PARM_LOOP_TITLE                  119     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG_1                   120     /* control type: textMsg, callback function: (none) */
#define  PARM_TEXTMSG                     121     /* control type: textMsg, callback function: (none) */
#define  PARM_MEAS_TITLE                  122     /* control type: textMsg, callback function: (none) */
#define  PARM_POWER_TITLE                 123     /* control type: textMsg, callback function: (none) */
#define  PARM_SYNC_TITLE                  124     /* control type: textMsg, callback function: (none) */
#define  PARM_OSCILL_TITLE                125     /* control type: textMsg, callback function: (none) */
#define  PARM_FILE_TITLE                  126     /* control type: textMsg, callback function: (none) */
#define  PARM_JUMP_TITLE                  127     /* control type: textMsg, callback function: (none) */
#define  PARM_INFO_TITLE                  128     /* control type: textMsg, callback function: (none) */
#define  PARM_CHANN_TITLE                 129     /* control type: textMsg, callback function: (none) */
#define  PARM_SPC_TITLE_2                 130     /* control type: textMsg, callback function: (none) */
#define  PARM_FLOW_TITLE                  131     /* control type: textMsg, callback function: (none) */
...
#define  SWAB_FREQMULT                    39      /* control type: numeric, callback function: Setting */
