...
#define DAQmx_Read_OpenCurrentLoopChans                                  0x2A0A // Indicates the names of any virtual channels in the task for which the device(s) detected an open current loop. You must read DAQmx_Read_OpenCurrentLoopChansExist before you read this property. Otherwise, you will receive an error.
...
#define DAQmx_Read_OverloadedChans                                       0x2175 // Indicates the names of any overloaded virtual channels in the task. You must read DAQmx_Read_OverloadedChansExist before you read this property. Otherwise, you will receive an error.
...
#define DAQmx_AnlgEdge_RefTrig_Hyst                                      0x1421 // Specifies a hysteresis level in the units of the measurement. If DAQmx_AnlgEdge_RefTrig_Slope is DAQmx_Val_RisingSlope, the trigger does not deassert until the source signal passes below DAQmx_AnlgEdge_RefTrig_Lvl minus the hysteresis. If DAQmx_AnlgEdge_RefTrig_Slope is DAQmx_Val_FallingSlope, the trigger does not deassert until the source signal passes above DAQmx_AnlgEdge_RefTrig_Lvl plus the hysteresis.
...
#define DAQmx_Write_OvercurrentChans                                     0x29E9 // Indicates the names of any virtual channels in the task for which an overcurrent condition has been detected. You must read DAQmx_Write_OvercurrentChansExist before you read this property. Otherwise, you will receive an error.
...
#define DAQmx_Write_OpenCurrentLoopChans                                 0x29EB // Indicates the names of any virtual channels in the task for which the device(s) detected an open current loop. You must read DAQmx_Write_OpenCurrentLoopChansExist before you read this property. Otherwise, you will receive an error.
...
#define DAQmx_Write_PowerSupplyFaultChans                                0x29ED // Indicates the names of any virtual channels in the task that have a power supply fault. You must read DAQmx_Write_PowerSupplyFaultChansExist before you read this property. Otherwise, you will receive an error.
