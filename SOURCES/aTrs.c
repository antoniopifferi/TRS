...
/* ######################################################################## */
/* 									   										*/
/* 		TRSInterface.C	Time-Resolved Spectroscopy   Release 7.0  Oct 2006  */
/* 									   										*/
/* ######################################################################## */
...
int CVICALLBACK Setting (int panel, int control, int event,
...
void CreateTable(void){
	...
	// ITEMS  607 = 27+3+5+17+7+3+9+2+6+154+90+150+30+48+18+33+4+1
	...
	for(ib=0;ib<MAX_BOARD;ib++)
		AddTab(CE,TSTRING,PARM,PARM_SPC_SETTINGS_1+ib,"SpcSettings",ib+1,0,P.Spc.Settings[ib]);
